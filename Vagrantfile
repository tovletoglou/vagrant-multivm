...
vm_array = Array[
  ['theseus.dev',   '192.168.33.10'],
  ['jason.dev',     '192.168.33.11'],
  ['asklepios.dev', '192.168.33.12']
]
...
Vagrant.configure('2') do |config|
  ...
  # end
  #
  # Extra provisioning example for the VM 'theseus':
  #
  # config.vm.define 'theseus' do |node|
  #   node.vm.provision 'shell', name: 'Install git' do |s|
  #     s.inline = <<-SHELL
